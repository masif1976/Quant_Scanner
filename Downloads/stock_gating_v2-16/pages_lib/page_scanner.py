...
def _score_bar(rows):
    ...
    colors = [r.get("status_color", theme.MUTED) for r in rows]
...
- **🟢 FULL DEPLOY (Score 70 - 100):** Healthy, low-risk bull environment.
...
- **🟡 REDUCED (Score 40 - 69):** Mixed, turbulent environment. The market is
  ...
  - **Shorts:** Favorable environment for shorting weak stocks (Tranche 2 Lean
    Shorts).
- **🔴 DEFENSIVE (Score 0 - 39):** High-risk, algorithmic unwind environment.
...
def render():
        ...
        st.markdown(
            ...
            <div class='panel' style='text-align:center;padding:44px;
              ...
              <div class='tiny' style='margin-top:12px'>
                Macro score <b>{macro['composite_score']:.0f}</b> — DEFENSIVE.
    ...
    if scanner is None or scanner.get("strategy") != strategy:
